...
const DEFAULT_FORM_ROW_FIELDS = [
  ...
  { name: 'subject', label: 'Subject', type: 'dropdown', inputType: 'dropdown', options: ['ขออนุมัติ', 'ขอให้ดำเนินการ', 'ให้ข้อคิดเห็น', 'แจ้งให้ทราบ'], required: false },
  ...
  { name: 'attnTo', label: 'ATTN TO', type: 'user_multiselect', required: true },
  { name: 'auditor', label: 'Checked by', type: 'user_multiselect', required: false },
